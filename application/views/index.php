                ...
                <ul>
                    <li data-index="rs-1" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off" data-easein="default" data-easeout="default" data-masterspeed="300" data-thumb="<?php echo base_url().'images/slides/slider-mainbg-002.jpg';?>" data-rotate="0" data-saveperformance="off" data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                        ...
                        <div class="tp-caption slide-main-text tp-resizeme" id="slide-1-layer-2" data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']" data-y="['middle','middle','middle','middle']" data-voffset="['-85','-85','-85','-61']"
                            ...
                            data-paddingleft="[0,0,0,0]">Dr. Mark Hoffman's Delmont Clinic Welcomes You! </div>
                        ...
                        <div class="tp-caption slide-main-text tp-resizeme"  id="slide-1-layer-3" data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']" data-y="['middle','middle','middle','middle']" data-voffset="['-17','-17','-28','-18']"
                            ...
                            data-paddingright="[0,0,0,0]"
                            data-paddingbottom="[0,0,0,0]"
                            data-paddingleft="[0,0,0,0]">A Medical <strong class="ttm-textcolor-skincolor">Care</strong> 
                        </div>
                        ...
                        <a class="tp-caption white-flatborder-button tp-resizeme" href="#" target="_self" id="slide-1-layer-5" data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']" data-y="['middle','middle','middle','middle']" data-voffset="['151','151','119','96']"
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-12">
                        <a class="ttm-btn ttm-btn-size-md ttm-btn-shape-square ttm-btn-style-border ttm-btn-color-black mt-45 mb-30 res-991-mt-0 float-right" href="#">VIEW MORE TIPS</a>
                    </div>
                </div><!-- row end -->
                <div class="row">
                    <div class="col-lg-12">
                        <div class="sep_holder_box width-100 mb-40 res-991-mt-0">
                            <span class="sep_holder"><span class="sep_line"></span></span>
                            <span class="sep_holder"><span class="sep_line"></span></span>
                        </div>
                    </div>
        ...
        <section class="ttm-row fid-section ttm-bg ttm-bgcolor-skincolor clearfix">
            ...
            <div class="container">
                <div class="row ttm-facts-colum-sep">
                    ...
                    <div class="col-md-3 col-sm-3">                                           <li class="active"><a href="<?php echo base_url().'Nsambya';?>">Home</a></li>
