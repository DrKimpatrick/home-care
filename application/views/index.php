<?php $page = 'home'; include('includes/header.php');?>
        ...
        <div id="rev_slider_4_4_wrapper" class="rev_slider_wrapper fullwidthbanner-container slide-overlay" data-alias="classic4export" data-source="gallery">
            ...
            <div id="rev_slider_4_4" class="rev_slider fullwidthabanner" data-version="5.4.8.2">
                <ul>
                    <li data-index="rs-1" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off" data-easein="default" data-easeout="default" data-masterspeed="300" data-thumb="<?php echo base_url().'images/slides/slider-mainbg-002.jpg';?>" data-rotate="0" data-saveperformance="off" data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">

                        <img src="<?php echo base_url().'images/slides/slider-mainbg-002.jpg';?>" alt="" title="Home 2" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>

                        <div class="tp-caption slide-main-text shape-rectangle tp-resizeme" id="slide-1-layer-1" data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']" data-y="['middle','middle','middle','middle']" data-voffset="['-135','-135','-135','-105']"
                            ...
                            data-paddingleft="[18,18,18,15]">LED BY PASSIONATE EXPERTS 
                        </div>
                        ...
                        <div class="tp-caption slide-main-text tp-resizeme" id="slide-1-layer-2" data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']" data-y="['middle','middle','middle','middle']" data-voffset="['-85','-85','-85','-61']"
                            ...
                            data-paddingleft="[0,0,0,0]">Nsambya Home care Welcomes You! </div>
                        ...
                        <div class="tp-caption slide-main-text tp-resizeme"  id="slide-1-layer-3" data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']" data-y="['middle','middle','middle','middle']" data-voffset="['-17','-17','-28','-18']"
                            ...
                            data-paddingright="[0,0,0,0]"
                            data-paddingbottom="[0,0,0,0]"
                            data-paddingleft="[0,0,0,0]">A Home <strong class="ttm-textcolor-skincolor">Care</strong> 
                        </div>
                    ...
                    <li data-index="rs-2" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off" data-easein="default" data-easeout="default" data-masterspeed="300" data-thumb="<?php echo base_url().'images/slides/slider-mainbg-001.jpg';?>" data-rotate="0" data-saveperformance="off" data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">

                        <img src="<?php echo base_url().'images/slides/slider-mainbg-001.jpg';?>" alt="" title="Home 2" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>

                        <div class="tp-caption slide-main-text shape-rectangle tp-resizeme" id="slide-2-layer-2" data-x="['left','left','left','center']" data-hoffset="['50','40','30','0']" data-y="['top','top','top','middle']" data-voffset="['308','161','56','-100']"
                            ...
                            data-paddingleft="[19,19,15,12]">FAST, AFFORDABLE & RELIABLE 
                        </div>
                        ...
                        <div class="tp-caption slide-main-text tp-resizeme" id="slide-2-layer-3" data-x="['left','left','left','center']" data-hoffset="['50','40','30','0']" data-y="['top','top','top','middle']" data-voffset="['363','211','110','-50']"
                            ...
                            data-paddingright="[0,0,0,0]"
                            data-paddingbottom="[0,0,0,0]"
                            data-paddingleft="[0,0,0,0]">A holistic Home-Care
                        </div>
                        ...
                        <div class="tp-caption slide-main-text tp-resizeme" id="slide-2-layer-4" data-x="['left','left','left','center']" data-hoffset="['50','40','30','0']" data-y="['top','top','top','middle']" data-voffset="['434','276','166','-9']"
                            ...
                            data-paddingright="[0,0,0,0]"
                            data-paddingbottom="[0,0,0,0]"
                            data-paddingleft="[0,0,0,0]"><strong class="ttm-textcolor-skincolor"> quality </strong>   service
                        </div>
                                    ...
                                    <div class="featured-icon-box top-icon featured-icon-hover text-center">
                                        ...
                                        <div class="featured-content">
                                            <div class="featured-title">
                                                <h5>Free medical care</h5>
                                            </div>
                                            <div class="featured-desc">
                                                <p>Our Home care hospital utilizes state-of-the-art technology and employs a team of true experts.</p>
                                            </div>
                                        </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <div class="featured-imagebox ttm-box-view-top-image box-shadow res-991-mb-30">
                            ...
                            <div class="featured-content featured-content-bottom">
                                <div class="featured-title">
                                    <h5><a href="single-blog.html">Pharmacy</a></h5>
                                </div>
                                <div class="featured-desc">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="featured-imagebox ttm-box-view-top-image box-shadow res-991-mb-30">
                            ...
                            <div class="featured-content featured-content-bottom">
                                <div class="featured-title">
                                    <h5><a href="single-blog.html">Counselling</a></h5>
                                </div>
                                <div class="featured-desc">
                                    <p>Our Cardiology hospital utilizes state-of-the-art technology and employs a team of true experts.</p>
                                    <a class="ttm-btn ttm-btn-size-sm ttm-btn-color-skincolor btn-inline mb-5" href="#">READ MORE</a>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="featured-imagebox ttm-box-view-top-image box-shadow res-991-mb-30">
                            ...
                            <div class="featured-content featured-content-bottom">
                                <div class="featured-title">
                                    <h5><a href="single-blog.html">Social works</a></h5>
                                </div>
                                <div class="featured-desc">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="mt-50 text-center res-991-mt-0">
                             <strong>Don’t hesitate, contact us for better help and services. <span class="ttm-textcolor-darkgrey"><u><a href="<?php echo base_url().'Nsambya/Services'; ?>">View more services</a></u></span></strong>
                        </div>
                    </div>
                </div>
            </div>
