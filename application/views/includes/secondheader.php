...
<title>NHC &#8211; Nsambya Home Care</title>

<!-- favicon icon -->
<link rel="shortcut icon" href="<?php echo base_url().'images/nhc4.png';?>"  style="max-height:50%"/>
                ...
                <div class="container">
                    <div class="ttm-topbar-content">
                        ...
                        <div class="topbar-right text-right">
                            ...
                            <a class="ttm-btn ttm-btn-size-md ttm-btn-shape-square ttm-btn-style-fill ttm-btn-color-skincolor" href="#"><i class="fa fa-money "></i>&nbsp; &nbsp; &nbsp; Donate</a>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="site-header-menu-inner ttm-stickable-header">
                            <div class="container">
                                ...
                                <div class="site-branding">
                                    <a class="home-link" href="<?php echo base_url().'Nsambya';?>" title="Delmont" rel="home">
