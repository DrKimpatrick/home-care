                ...
                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-5 widget-area">
                    <div class="widget widget_text clearfix">
                        ...
                        <div class="textwidget widget-text">
                            ...
                            <br><br>We are among the most qualified implant providers in Uganda with over 32 years of quality training and experience.
                            <br><br>
    ...
    <div class="bottom-footer-text ttm-textcolor-white">
        <div class="container">
            <div class="row copyright">
                <div class="col-md-12">
                    <span>Copyright © <?php date_default_timezone_set('Africa/Kampala'); echo date("Y"); ?> Nsambya home care department</span>
                </div>
                <div class="col-md-12">
