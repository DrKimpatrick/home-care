                    ...
                    <div class="col-md-12"> 
                        <div class="title-box ttm-textcolor-white">
                            <div class="page-title-heading">
                                ...
                                <h3 class="subtitle"> About Nsambya Home Care</h3>
                            ...
                            <div class="col-lg-9">
                                <div class="pt-105 pb-30 res-1199-plr-15 res-991-pt-50">
                                    ...
                                    <div class="accordion">
                                        ...
                                        <div class="toggle">
                                            ...
                                            <div class="toggle-content">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <p>
                                                        Provide with love holistic home-based quality services to HIV/AIDS infected and affected, their families and communities
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <!-- toggle -->
                                        <div class="toggle">
                                            <div class="toggle-title"><a data-toggle="collapse" data-parent="#accordion" href="#collapseThree" >Our Vision</a></div>
                                            <div class="toggle-content">
                                                <div class="row">
                                                    <div class="col-sm-3">
                                                        <div class="toggle-figure res-991-mb-15">
