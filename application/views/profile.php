                                    ...
                                    <div class="ttm-team-member-single-content-area col-md-12 col-lg-7">
                                        <div class="ttm-team-member-content shadow-box">
                                            <div class="ttm-team-member-single-list">
                                                <h2 class="ttm-team-member-single-title">Dr. Metthew Wood</h2>
                                                <h5 class="ttm-team-member-single-position">Senior Dr. at Delmont</h5>
                                                    ...
                                                    <div class="ttm-team-details-wrapper">
                                                        <ul class="ttm-team-details-list clearfix">
                                                            <li>
                                                                ...
                                                                <div class="ttm-team-list-value"><a href="tel:(123)456-7890"> (123) 456-7890</a></div>
                                                            </li>
                                                            <li>
                                                                <div class="ttm-team-list-title">
                                    ...
                                    <div class="pt-5 row">
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            <div class="ttm_single_image-wrapper">
                                                <img class="img-fluid" src="<?php echo base_url().'images/single-img-five.jpg'; ?>" alt="">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="featured-icon-box left-icon icon-align-top">
                            ...
                            <div class="featured-content">
                                ...
                                <div class="featured-desc">
                                    <p>Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit, sed quia non numquam modi tempora incidunt ut labore et dolore.</p>
                                </div>
                            </div>
                        </div><!-- featured-icon-box end-->
                    </div>
                    <div class="col-lg-6 col-md-12">
                        <div class="ttm-tabs ttm-tab-color-grey ttm-tab-style-classic res-991-mt-30 clearfix">
                            ...
                            <ul class="tabs">
                                ...
                                <li class="tab"><a href="#">Skills</a></li>
                                <li class="tab"><a href="#">Experience</a></li>
                            </ul>
                            <div class="content-tab">
                                <div class="content-inner">
                                    <h5>Practical Degree From NY</h5>
                                    <span class="ttm-textcolor-skincolor">2016-2018</span>
                                    <div class="mb-25">
                                ...
                                <div class="content-inner">
                                    ...
                                    <div class="ttm-progress-bar ttm-icon-left-true">
                                        <div class="ttm-icon_element-color-skincolor">
                    ...
                    <div class="col-lg-12">
                        ...
                        <form class="wrap-form clearfix" method="post" action="#">
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <label>
                                        <span class="text-input"><input name="your-email" type="text" value="" placeholder="Email*:" required="required"></span>
                                    </label>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <input name="submit" type="submit" id="submit" class="ttm-btn ttm-btn-size-md ttm-btn-shape-square ttm-btn-style-fill ttm-btn-bgcolor-skincolor mt-10" value="SEND MESSAGE"/>
                        </form>
                    </div>
                </div>
            </div>
